                    ...
                    <div class="product-status-wrap">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>Hóa đơn 1</td>
                                <td>
                                    <button class="y-setting">Chờ xác nhận</button>
                                </td>
                                <td>5/1/2023</td>
                                <td>900000vnd</td>
                                <td>
                                    ...
                                    <a href="product-edit.jsp">
                                        <button data-toggle="tooltip" title="Cập nhật trạng thái" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>Hóa đơn 1</td>
                                <td>
                                    <button class="g-setting">Đã xác nhận</button>
                                </td>
                                <td>5/1/2023</td>
                                <td>900000vnd</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Hóa đơn 1</td>
                                <td>
                                    <button class="b-setting">Đang giao hàng</button>
                                </td>
                                <td>5/1/2023</td>
                                <td>900000vnd</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Hóa đơn 1</td>
                                <td>
                                    <button class="gr-setting">Đã giao hàng</button>
                                </td>
                                <td>5/1/2023</td>
                                <td>900000vnd</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Hóa đơn 1</td>
                                <td>
                                    <button class="r-setting">Đơn bị hủy</button>
                                </td>
                                <td>5/1/2023</td>
                                <td>900000vnd</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Hóa đơn 1</td>
                                <td>
                                    <button class="gr-setting">Đang giao hàng</button>
                                </td>
                                <td>5/1/2023</td>
                                <td>900000vnd</td>
                                <td>

...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            ...
            <%@ include file="/admin/layout-left-custom-menu-adp-wrap.jsp" %>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="product-edit.jsp">Chỉnh sửa sản phẩm</a></li>
                                                <li><a href="product-detail.jsp">Chi tiết sản phẩm</a></li>
                                                <li><a href="product-cart.jsp">Giỏ hàng</a></li>
                                                <li><a href="product-payment.jsp">Thanh toán</a></li>
                                                <li><a href="analytics.html">Phân tích</a></li>
                                                <li><a href="widgets.html">Tiện ích</a></li>
                                            </ul>
                                        </li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												...
												<p>Xin chào <span class="bread-ntd">Admin!</span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        ...
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="ps-setting">Dừng bán</button>
                                    </td>
                                    <td>60</td>
                                    <td>11/1/2023</td>
                                    <td>750000vnd</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="ds-setting">Không được bán</button>
                                    </td>
                                    <td>70</td>
                                    <td>5/1/2023</td>
                                    <td>750000vnd</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="pd-setting">Hỏa động</button>
                                    </td>
                                    <td>30</td>
                                    <td>5/1/2023</td>
                                    <td>750000vnd</td>

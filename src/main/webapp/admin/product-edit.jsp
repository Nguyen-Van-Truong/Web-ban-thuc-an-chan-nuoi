                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <label style="color: white">Trạng thái hiện tại</label>
                                                        <select name="select"
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <ul style="color: white; display: flex; flex-wrap: wrap">
                                                            <li style="padding: 20px;"><input type="checkbox">Nguồn gốc
                                                                động vật
                                                            </li>
                                                            <li style="padding: 20px;"><input type="checkbox">Nguồn gốc
                                                                thực vật
                                                            ...
                                                            <li style="padding: 20px;"><input type="checkbox">Thức ăn
                                                                thô
                                                            </li>
                                                            <li style="padding: 20px;"><input type="checkbox">Thức ăn
                                                                tinh
                                                            ...
                                                            <li style="padding: 20px;"><input type="checkbox">Thức ăn ủ
                                                                chua
                                                            </li>
